      ...
      <div className='info_list'>
        <div>
          ...
          <div className='info_detail'>
            ...
            프로젝트를 하며 새로운 라이브러리나 프레임워크를 배우는 것을 즐겨해서 프로젝트마다 새로운 기능을 넣고<br />
        ...
        <div>
          <h2>Q. 당신은 어떤 개발자가 되고싶나요?</h2>
            <div className='info_detail'>
              ...
              돈이란 성장에 재미를 느낄수 있는 큰 원동력이라고 생각하고 ,<br />
              저는 그 원동력으로 빠른성장을 해서 경력이상의 실력을가진 개발자가 되고싶습니다.
            </div>
        </div>
        <div>
          <h2>Q. 그런 개발자가 되기위해 어떤 노력을 하고 계신가요?</h2>
            <div className='info_detail'>
              ...
              사용하며 익혀지지않는부분은 강의구매로 클론코딩을하여 익혀서 프로젝트에 적용시키고있습니다.
            </div>
        </div>
      </div>
    </div>
