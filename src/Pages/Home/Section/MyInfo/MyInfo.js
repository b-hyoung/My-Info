      ...
      <div className='info_list'>
        <div>
          ...
          <div className='info_detail'>
            ...
            React 원페이지 렌더링에 흥미를 느껴서 해당 라이브러리로 개발중입니다. <br />
            프로젝트를 진행하면서 새로운 라이브러리를 배우는 것을 즐겨해서 프로젝트마다 새로운 기능을 넣고<br />
        ...
        <div>
          <h2>Q. 당신은 어떤 개발자가 되고싶나요?</h2>
            <div className='info_detail'>
              ...
              돈이란 성장에 재미를 느낄수 있는 큰 원동력이자 저의 가치라고 생각합니다.<br />
        ...
        <div>
          <h2>Q. 그런 개발자가 되기위해 어떤 노력을 하고 계신가요?</h2>
            <div className='info_detail'>
              ...
              사용해보면서 익혀지지 않았던 부분은 강의구매 또는 클론코딩을 통해 프로젝트에 적용시키고있습니다. <br />
            </div>
        </div>
      </div>
    </div>
